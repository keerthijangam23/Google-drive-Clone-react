...
describe("ModelPOpup testing",()=>{
    ...
    test("checking whether model Pop up  is rendering or not",()=>{
        ...
        const {getByTestId}= render(<ModelPopup idValue={"1"} nameValue={"folder1"} handleSubmit={handleSubmit} handleClose={handleClose}/>)
        ...
        const inputValue = getByTestId("folder-input").value;
        expect(inputValue).toBe("folder1");
